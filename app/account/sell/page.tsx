      ...
      <div className="md:flex justify-between gap-4">
        <div className="flex-1 mb-2 md:mb-0">
          <Table aria-label="Example static collection table">
            <TableHeader>
              <TableColumn className="text-sm md:text-base">{t('common.item')}</TableColumn>
              <TableColumn className="text-sm md:text-base">{t('common.unit_rice')}</TableColumn>
              <TableColumn className="text-sm md:text-base">{t('common.amount')}</TableColumn>
            </TableHeader>
            <TableBody>
              {list.map((item, i) => (

    ...
    <div>
      ...
      <div className="pt-2">
        {inputList.items.map((item, i) => (
            <div className="pb-3 grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-4 key={i}">
    ...
    <div>
      ...
      <div className="pt-2">
        {outputList.items.map((item, i) => (
          <div className="pb-3 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 key={i}"> 
            <div className='flex col-span-2 justify-center items-center'> {i+1}. 
              <Input

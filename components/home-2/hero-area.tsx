...
import ArrowLine from '@/components/svg/arrow-line';
import RoundLine from '@/components/svg/round-line';
import useCharAnimation from '@/components/hooks/useCharAnimation';
    ...
    <>
      ...
      >
        ...
        <div className="container-fluid g-0">
          <div className="row g-0 align-items-end columns-1 md:columns-2">
            <div className="col-xl-6 col-lg-6 w-full">

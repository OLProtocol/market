...
const OpenAccountArea = () => {
  return (
    <>
      <div className="tp-account-area pb-120 bg-white">
        <div className="container">
          <div className="row align-items-center columns-1 md:columns-2">
            ...
            <div className="col-xl-6 col-lg-6 w-full">
              <div className="tp-account-step-wrapper">
                <div className="tp-account-section-box mb-40 text-gray-500">

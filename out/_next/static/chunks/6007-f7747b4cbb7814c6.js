...
(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
  [6007],
  {
    ...
    19355: function (e, t, n) {
      ...
      let l = /^[a-z0-9]+(-[a-z0-9]+)*$/,
        a = (e, t, n, i = '') => {
          ...
          if (r.length > 1) {
            let e = r.pop(),
              n = r.pop(),
              o = { provider: r.length > 0 ? r[0] : i, prefix: n, name: e };
            return t && !s(o) ? null : o;
          }
          let o = r[0],
            l = o.split('-');
          if (l.length > 1) {
            let e = { provider: i, prefix: l.shift(), name: l.join('-') };
            return t && !s(e) ? null : e;
          }
          if (n && '' === i) {
            let e = { provider: i, prefix: '', name: o };
        ...
        f = Object.freeze({ rotate: 0, vFlip: !1, hFlip: !1 }),
        u = Object.freeze({ ...c, ...f }),
        d = Object.freeze({ ...u, body: '', hidden: !1 });
      function h(e, t) {
        let n = (function (e, t) {
          let n = {};
      ...
      let g = { provider: '', aliases: {}, not_found: {}, ...c };
      function m(e, t) {
      ...
      function b(e) {
        ...
        for (let e in t) {
          let n = t[e];
          if (!e.match(l) || 'string' != typeof n.body || !m(n, d)) return null;
        }
      ...
      let j = Object.freeze({ width: null, height: null }),
        _ = Object.freeze({ ...j, ...f }),
        S = /(-?[0-9.]*[0-9]+[0-9.]*)/g,
        E = /^-?[0-9.]*[0-9]+[0-9.]*$/g;
      function O(e, t, n) {
      ...
      for (; D.length > 0; )
        1 === D.length
          ...
          : Math.random() > 0.5
            ? N.push(D.shift())
            : N.push(D.pop());
      R[''] = P({ resources: ['https://api.iconify.design'].concat(N) });
      let z = (() => {
        let e;
        try {
      ...
      function Y(e) {
        return parseInt(X(e, W)) || 0;
      }
      let Z = { local: !0, session: !0 },
      ...
      function er(e, t) {
        ...
        if (i !== J) {
          if (i) {
            let e = Y(n);
            for (let t = 0; t < e; t++) K(n, Q + t.toString());
          }
          G(n, B, J), V(n, 0);
          return;
        }
      ...
      let ea = (e, t) => {
          ...
          let r = (function (e) {
              ...
              e.forEach((e) => {
                ...
                (l in s.icons
                  ...
                  : '' === o || s.missing.has(l)
                    ? t.missing
                    : t.pending
                ).push({ provider: r, prefix: o, name: l });
              }),
              t
            );
          })(
            (function (e, t = !0, n = !1) {
              ...
              return (
                e.forEach((e) => {
                  let r = 'string' == typeof e ? a(e, t, n) : e;
                  r && i.push(r);
                }),
                i
              );
          ...
          if (!r.pending.length) {
            ...
            return (
              t &&
                setTimeout(() => {
                  e && t(r.loaded, r.missing, r.pending, el);
                }),
              () => {
                e = !1;
              }
          ...
          return (
            r.pending.forEach((e) => {
              ...
              if (r === i && t === n) return;
              (n = t), (i = r), l.push(v(t, r));
              let a = o[t] || (o[t] = Object.create(null));
              a[r] || (a[r] = []);
            }),
            r.pending.forEach((e) => {
              let { provider: t, prefix: n, name: i } = e,
                r = v(t, n),
                l = r.pendingIcons || (r.pendingIcons = new Set());
              l.has(i) || (l.add(i), o[t][n].push(i));
            }),
            l.forEach((e) => {
              ...
              if (o[t][n].length) {
                ...
                (i = o[t][n]),
                  e.iconsToLoad
                    ? (e.iconsToLoad = e.iconsToLoad.concat(i).sort())
                    : (e.iconsToLoad = i),
                  e.iconsQueueFlag ||
                    ((e.iconsQueueFlag = !0),
                    setTimeout(() => {
                          ...
                          t.prepare(n, i, r).forEach((t) => {
                            !(function (e, t, n) {
                              ...
                              if ('string' == typeof e) {
                                ...
                                if (t) {
                                  i = H(t);
                                  let n = T(e.resources ? e.resources[0] : '');
                                  n && (r = n.send);
                                }
                              }
                              i && r
                                ...
                                try {
                                  ...
                                  i &&
                                    ...
                                    (function (e, t) {
                                      function n(n) {
                                        let i, r;
                                        if (!Z[n] || !(i = ei(n))) return;
                                        let o = ee[n];
                                        if (o.size)
                                          o.delete((r = Array.from(o).shift()));
                                        else if (((r = Y(i)), !V(i, r + 1)))
                                          return;
                                        let l = {
            ...
            t
              ? (function (e, t, n) {
                  ...
                  let o = { id: i, icons: t, callback: e, abort: r };
                  return (
                    n.forEach((e) => {
        ...
        eh = { backgroundColor: 'transparent' },
        ep = { Image: 'var(--svg)', Repeat: 'no-repeat', Size: '100% 100%' },
        eg = { WebkitMask: ed, mask: ed, background: eh };
      for (let e in eg) {
        let t = eg[e];
      ...
      let ey = (e, t, n, r) => {
          ...
          a = (function (e, t) {
            ...
            for (let e in t) {
              let i = t[e],
                r = typeof i;
              e in j
                ? (null === i || (i && ('string' === r || 'number' === r))) &&
                  (n[e] = i)
                : r === typeof n[e] && (n[e] = 'rotate' === e ? i % 4 : i);
            }
            return n;
          })(l, t),
          s = t.mode || 'svg',
        ...
        let h = (function (e, t) {
            ...
            let s = o.width,
              ...
              d = l.height;
            null === s
              ? (n = O((i = null === c ? '1em' : 'auto' === c ? d : c), f / d))
              : ((n = 'auto' === s ? f : s),
                (i = null === c ? O(n, d / f) : 'auto' === c ? d : c));
            let h = {},
              p = (e, t) => {
                M(t) || (h[e] = t.toString());
              };
        ...
        if ((a.inline && (c.verticalAlign = '-0.125em'), 'svg' === s)) {
          ...
          return (
              ...
              __html:
                ((g = (function (e, t = L) {
                  ...
                  return (
                    i.forEach((n) => {
                      let i =
                          'function' == typeof t ? t(n) : t + (C++).toString(),
                        o = n.replace(/[.*+?^${}()|[\]\\]/g, '\\$&');
                      e = e.replace(
                        RegExp('([#;"])(' + o + ')([")]|\\.[a-z])', 'g'),
                        '$1' + i + r + '$3',
            ...
            o.createElement('svg', d)
          );
        }
        let { body: m, width: b, height: y } = e,
          v = 'mask' === s || ('bg' !== s && -1 !== m.indexOf('currentColor')),
          x = (function (e, t) {
            let n =
              -1 === e.indexOf('xlink:')
                ? ''
      ...
      class ev extends o.Component {
        ...
        _checkIcon(e) {
          ...
          let n = this.state,
            i = this.props.icon;
          if ('object' == typeof i && null !== i && 'string' == typeof i.body) {
            (this._icon = ''),
              this._abortLoading(),
              (e || null === n.icon) && this._setData({ data: i });
            return;
          }
          if ('string' != typeof i || null === (t = a(i, !1, !0))) {
            this._abortLoading(), this._setData(null);
            return;
          }
          let r = (function (e) {
            let t = 'string' == typeof e ? a(e, !0, w) : e;
            if (t) {
          ...
          if (!r) {
            (this._loading && this._loading.name === i) ||
              (this._abortLoading(),
              (this._icon = ''),
              this._setData(null),
              null !== r &&
        ...
        render() {
          let e = this.props,
            t = this.state.icon;
          if (null === t)
            return e.children ? e.children : o.createElement('span', {});
          let n = e;
          return (
            t.classes &&
              (n = {
            ...
            ey({ ...u, ...t.data }, n, e._inline, e._ref)
          );
        }
      }
      let ex = o.forwardRef(function (e, t) {
        let n = { ...e, _ref: t, _inline: !1 };
        return o.createElement(ev, n);
      });

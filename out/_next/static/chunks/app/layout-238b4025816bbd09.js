(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
  [3185],
  {
    94654: function (e, t, i) {
      Promise.resolve().then(i.bind(i, 15272));
    },
    15272: function (e, t, i) {
      'use strict';
      i.r(t),
        i.d(t, {
          default: function () {
      ...
      var s = i(88961),
        ...
        c = i(85169);
      function d(e) {
        let { children: t, themeProps: i } = e,
          s = (0, o.useRouter)();
        return (0, r.jsx)(n.w, {
          navigate: s.push,
          children: (0, r.jsx)(c.f, { ...i, children: t }),
        });
      }
      var _ = i(62121),
        u = i(77446),
      ...
      let C = () => {
        let { i18n: e } = (0, T.$G)(),
          [t, i] = (0, l.useState)(new Set([e.language]));
        return (
          (0, l.useMemo)(
            () => Array.from(t).join(', ').replaceAll('_', ' '),
            [t],
          ),
          (0, r.jsxs)(S.F, {
            children: [
              ...
              (0, r.jsx)(O.a, {
                ...
                onSelectionChange: (t) => {
                  ...
                  r && e.changeLanguage(r), i(t);
                },
                children: [
                  { key: 'en', label: 'Engish' },
                  { key: 'zh-CN', label: '中文' },
                ].map((e) => (0, r.jsx)(D.W, { children: e.label }, e.key)),
              }),
            ],
          })
        );
      ...
      var A = i(87138),
        ...
        I = i(65647);
      let L = () => {
        let { setAppVersion: e } = (0, I.Ee)(),
          { t } = (0, T.$G)(),
          [i, s] = (0, l.useState)(!1),
          a = () => {
            s(!0);
          };
        (0, U.ZP)('getAppVersion-'.concat(209), () => (0, F.Sf)(), {
          refreshInterval: 12e4,
          onSuccess: (e) => {
            console.log(e), e && Number(e) > 209 && a();
          },
        });
        let n = (0, l.useRef)(),
          o = () => {
            n.current && clearTimeout(n.current),
              (n.current = setTimeout(() => {}, 3e5)),
              s(!1);
          };
        return (
          (0, l.useEffect)(() => {
          ...
          (0, r.jsx)(P.R, {
            ...
            children: (0, r.jsxs)(Y.A, {
              children: [
                (0, r.jsx)(R.k, {
                  className: '',
                  children: t('pages.app.version_update_title'),
                }),
                (0, r.jsxs)(B.R, {
                  children: [
                    (0, r.jsx)(w.A, {
      ...
      var E = i(76801),
        ...
        H = i(10847);
      let X = (e) => {
        let { label: t, value: i, onClick: s, className: a } = e;
        return (0, r.jsxs)('div', {
          className:
          ...
          onClick: s,
          children: [
            (0, r.jsx)('div', { className: 'text-lg font-bold', children: t }),
            (0, r.jsxs)('div', {
      ...
      var V = i(24842);
      let J = (e) => {
          let { onChange: t, feeRateData: i, value: s, feeType: a } = e,
            { t: n, i18n: o } = (0, T.$G)(),
            { network: c } = (0, V.$)((e) => e),
            [d, u] = (0, l.useState)('Normal'),
            [m, p] = (0, l.useState)(1),
            [h, f] = (0, l.useState)(1),
            [b, g] = (0, l.useState)(1),
            [x, y] = (0, l.useState)(1),
            [v, k] = (0, l.useState)(500),
            j = (e, i) => {
              d !== e && (u(e), null == t || t({ type: e, value: i }));
            },
            S = async () => {
              console.log('setRecommendFee', i);
              let e = 'testnet' === c ? 1 : 10;
              f((null == i ? void 0 : i.economyFee) || e),
                g((null == i ? void 0 : i.halfHourFee) || e),
                p((null == i ? void 0 : i.fastestFee) || e),
                y((null == i ? void 0 : i.minimumFee) || 1),
                u('Normal');
            },
            N = (0, l.useMemo)(
              () => [
                { label: 'Economy', name: n('common.fee_economy'), value: h },
                { label: 'Normal', name: n('common.fee_normal'), value: b },
                { label: 'Custom', name: n('common.fee_custom'), value: m },
              ],
              [h, b, m, o.language],
            );
          return (
            ...
            (0, l.useEffect)(() => {
              'Custom' === d && (null == t || t({ value: m, type: 'Custom' }));
            }, [m]),
            (0, l.useEffect)(() => {
              'Custom' === a && s ? (p(s), u(a)) : a && u(a);
            }, [a, s]),
            (0, r.jsxs)('div', {
              children: [
                (0, r.jsx)('div', {
                  ...
                  (0, r.jsxs)('div', {
                    ...
                    children: [
                      ...
                      (0, r.jsx)(H.L, {
                        ...
                        value: [m],
                        onChange: (e) => {
                          console.log(e), p(isNaN(e[0]) ? 0 : e[0]);
                        },
                      }),
                    ],
                  }),
        ...
        W = () => {
          let { t: e } = (0, T.$G)(),
            { network: t } = (0, V.$)((e) => e),
            { isOpen: i, onClose: s, onOpenChange: a, onOpen: n } = (0, E.q)(),
            [o, c] = (0, l.useState)({ value: 1, type: 'Normal' }),
            { data: d, isLoading: _ } = (0, U.ZP)(
              'getRecommendedFees-'.concat(t),
              () => (0, F.sQ)(),
              { refreshInterval: 6e5 },
            ),
            u = (0, l.useMemo)(
              () => ((null == d ? void 0 : d.code) === 200 ? d.data : {}),
              [d],
            ),
            { setFeeRate: m, feeRate: p } = (0, I.Ee)((e) => e);
          return (
            (0, l.useEffect)(() => {
              if (null == u ? void 0 : u.halfHourFee) {
                let e = null == u ? void 0 : u.halfHourFee;
                e &&
                  m({
                    value: (e = null == u ? void 0 : u.halfHourFee) || 1,
                    type: 'Normal',
                  });
              }
            }, [u]),
              ...
              children: [
                (0, r.jsxs)(w.A, {
                  ...
                  children: [
                    ...
                    ' ',
                    (0, r.jsx)('span', {
                      className: 'dark:text-gray-400 text-slate-600',
                      children: 'sat/vB',
                    }),
                  ],
                }),
                  ...
                  children: (0, r.jsxs)(Y.A, {
                    children: [
                      (0, r.jsx)(R.k, {
                        ...
                        children: e('common.gas_fee'),
                      }),
                      (0, r.jsx)(z.I, {
                        children: (0, r.jsx)(J, {
                          onChange: (e) => {
                            console.log('fee', e), c(e);
                          },
                          value: p.value,
                          feeType: p.type,
                          feeRateData: u,
      ...
      var $ = i(77634);
      let G = (0, j.default)(
          () => Promise.all([i.e(1271), i.e(3440)]).then(i.bind(i, 93440)),
          { loadableGenerated: { webpack: () => [93440] }, ssr: !1 },
        ),
        Z = () => {
          let { address: e, network: t } = (0, V.$)(),
            {
              setHeight: i,
              setBtcPrice: s,
              runtimeEnv: a,
            ...
            { t: S, i18n: N } = (0, T.$G)(),
            w = (0, o.usePathname)(),
            { data: O } = F.Ol.useBtcHeight(t),
            { data: D, trigger: M } = (0, $.Z)(
              'getUtxoByValue-'.concat(e, '-').concat(t),
              () => (0, F.wt)({ address: e, network: t, value: 500 }),
            ),
            { data: P } = (0, U.ZP)('getBTCPrice', () => (0, F.UZ)());
          (0, l.useEffect)(() => {
            var e, t;
            (null == D
              ? void 0
              ...
              c(
                null === (t = D.data) || void 0 === t
                  ...
                  : t.map((e) => ({
                      status: 'unspend',
                      location: 'remote',
                      utxo: ''.concat(e.txid, ':').concat(e.vout),
                      ...e,
                    })),
              );
          }, [D]),
          ...
          let Y = (e) => w === e,
            R = (0, l.useMemo)(() => {
              let e = [
                {
                  label: S('pages.market.title'),
                  href: '/market/',
                  isActive: !0,
                },
                {
                  label: S('pages.inscribe.title'),
                  href: '/inscribe/',
                  isActive: !0,
                },
                {
                  label: S('pages.explorer.title'),
                  href: ''.concat('https://app.sat20.org', '/#/explorer'),
                  target: '_blank',
                  isActive: !0,
                },
                {
                  label: S('pages.my_assets.title'),
                  href: '/account/',
                  isActive: !1,
                },
              ];
          ...
          return (
            (0, l.useEffect)(() => {
              location.hostname.startsWith('test')
                ? n('test')
                : location.hostname.indexOf('ordx') > -1 && n('prod');
            }, []),
            (0, r.jsxs)(m.R, {
              maxWidth: 'full',
              position: 'sticky',
                      ...
                      children: (0, r.jsxs)(A.default, {
                        ...
                        children: [
                          (0, r.jsx)(f.J, {
                            ...
                            src: '/logo.png',
                            alt: 'logo',
                            classNames: { wrapper: 'w-14 h-14 min-w-14' },
                          }),
                          (0, r.jsx)('p', {
                            className:
                              'font-bold text-purple-500/90 hidden md:block',
                            children: 'SAT20Market',
                          }),
                        ],
                      }),
                    }),
            ...
            (0, r.jsxs)('head', {
              children: [
                [
                  ...
                  (0, r.jsx)(
                    'link',
                    { rel: 'preload', href: e, as: 'script' },
                    t,
                  ),
                ),
                (0, r.jsx)('title', { children: 'Sat20 Market' }),
              ],
            }),
            (0, r.jsx)('body', {
              className: (0, q.Z)(
              ...
              children: (0, r.jsx)(d, {
                ...
                children: (0, r.jsxs)('div', {
                  ...
                  children: [
                    (0, r.jsx)(Z, {}),
                    (0, r.jsx)('main', {
                      className: 'mx-auto w-full px-2 md:px-4 flex-grow',
                      children: t,
                    }),
                    (0, r.jsx)('footer', {
                      id: 'footer',
                      children: (0, r.jsxs)('ul', {
                        className:
                          'flex justify-center gap-4 items-center text-gray-500',
                        children: [
                          (0, r.jsx)('li', {
                            children: (0, r.jsx)(k.O, {
                              href: 'https://twitter.com/sat20market/',
                              target: '_blank',
                              children: (0, r.jsx)(ed.h, {
                                showFallback: !0,
                                fallback: (0, r.jsx)(f.J, {
                                  src: '/twitter.png',
                                  alt: 'sat20 twitter',
                                }),
                              }),
                          ...
                          (0, r.jsx)('li', {
                            className: 'text-sm',
                            children: 'Copyrights\xa92024',
                          }),
                          (0, r.jsxs)('li', { children: ['V1.0.', i] }),
                        ],
                      }),
                    }),
                  ],
  ...
  function (e) {
    e.O(
      0,
      [
        2769, 7228, 9155, 3121, 1866, 1645, 8218, 3911, 1277, 4158, 6425, 9189,
        3368, 4621, 6007, 9662, 1752, 2745, 1447, 2971, 7023, 1744,
      ],
      function () {
        return e((e.s = 94654));
      },
